...
INSERT INTO public.employees (
  ...
  13, 1, 13, 'EMP-1012', NULL, 'Deborah', 'Obadina', 'Deborah Obadina', 'deborahobadina01@gmail.com', 'dobadina@m.experiential-edge.com', '+2348139203775', '6/5/1987', 'Married', 'Nigeria', '34 Greenland street egbeda', '34 Greenland street egbeda', 'Alimosho', 'Lagos', 'Lagos', 'Egbeda', NULL, 'Strategy', 'Account executive', '7/24/2025', 'Maryland', 'Mrs Chidinma', 'Dare otujinrin', 'Brother', '07030746413', NULL, 'Sterling bank', '0107337280', NULL, 'STAFF', TRUE, 'Missing official Staff ID (flagged for HR generation); Blood group unconfirmed', 'Account Created', 'active', '2026-09-17T23:39:47.401Z'
)
ON CONFLICT (id) DO UPDATE SET
  full_name = EXCLUDED.full_name,
  personal_email = EXCLUDED.personal_email,
...
INSERT INTO public.employees (
  ...
  23, 1, 23, 'EMP-1022', NULL, 'Izuchukwu', 'Valentine Nworah', 'Izuchukwu Valentine Nworah', 'valentine.nworah@gmail.com', 'valentine.nworah@gmail.com', '+2348060720372', '9/4/1989', 'Single', 'Nigerian', 'No 3 Adewale Balogun street, Powerline Busstop', 'No 3 Adewale Balogun street, Powerline Busstop', 'Isheri Alimosho', 'Anambra/ Lagos', 'Anambra/ Lagos', 'Powerline Busstop', NULL, 'Operations', 'VSR and Operations Manager', '1/21/2026', 'Ogba', 'Mrs. Vivian Osigweh', 'Nworah Stella', 'Mom', '08064722991', 'A+', 'Sterling Bank', '0036406994', NULL, 'MANAGER', TRUE, 'Missing official Staff ID (flagged for HR generation)', 'Account Created', 'active', '2026-09-17T23:39:47.629Z'
)
ON CONFLICT (id) DO UPDATE SET
  full_name = EXCLUDED.full_name,
  personal_email = EXCLUDED.personal_email,
...
INSERT INTO public.employees (
  ...
  27, 1, 27, 'EMP-1027', NULL, 'Owolebi', 'Ayomipo', 'Owolebi Ayomipo', 'owolebiayomipo@gmail.com', 'aowolebi@m.experiential-edge.com', '+2348027208651', '8/7/1996', 'Single', 'Nigeria', '72, buari street, ogudu, Ojota, Lagos, Nigeria.', '72, buari street, ogudu, ojota, lagos', 'Kosofe', 'Lagos', 'Lagos', 'Ojota', NULL, 'Creative', 'Graphic designer', '1/14/2025', 'office', 'Gloria Iwuh', 'Owolebi Victor', 'brother', '+234 805 339 7016', 'O', 'Owolebi Ayomipo', '2069581014', 'Art', 'STAFF', TRUE, 'Missing official Staff ID (flagged for HR generation)', 'Account Created', 'active', '2026-09-17T23:39:47.825Z'
)
ON CONFLICT (id) DO UPDATE SET
  full_name = EXCLUDED.full_name,
  personal_email = EXCLUDED.personal_email,
...
INSERT INTO public.employees (
  ...
  31, 1, 31, 'EMP-1031', NULL, 'Adeyemi', 'Vivian', 'Adeyemi Vivian', 'adeyemivivianomon@gmail.com', 'adeyemivivianomon@gmail.com', '+2348060815356', '10/9/1976', 'Married', 'Nigerian', 'No 9 mustapha street celeapatha Ayobo', 'No 9 mustapha street celeapatha Ayobo', 'Lagos/ Alimosho', 'Edo state', 'Edo state', 'So east', NULL, 'Chief', 'Chief / ware house manager', '5/24/2023', 'Maryland', 'Osigwe Vivian', 'Adeyemi oluwaseyi', 'Son', '07067186206', 'O +', 'First bank', '3048650541', 'Cooking,singing and reading', 'MANAGER', TRUE, 'Missing official Staff ID (flagged for HR generation)', 'Account Created', 'active', '2026-09-17T23:39:47.957Z'
)
ON CONFLICT (id) DO UPDATE SET
  full_name = EXCLUDED.full_name,
  personal_email = EXCLUDED.personal_email,
...
INSERT INTO public.employees (
  ...
  41, 1, 41, 'EMP-1041', NULL, 'Diepreye', 'Desmond', 'Diepreye Desmond', 'diepreyeyazzy@gmail.com', 'ddiepreye@m.experiential-edge.com', '+2347054353032', '3/23/2002', 'Single', 'Nigerian', 'Block 8 Flat 5 Airforce base shasha', 'Block 8 Flat 5 Airforce base shasha', 'Lagos', 'Bayelsa', 'Bayelsa', 'Oguntade', NULL, 'Strategy', 'Brand Development strategist', '11/24/2025', '15 Atiba Osborne street mende Maryland, Lagos, Nigeria,', 'Mrs Chidima', 'Mrs Diepreye Dinipere', 'Mother', '07037119544', 'O+', 'Gtbank', '0612300236', 'Art', 'STAFF', TRUE, 'Missing official Staff ID (flagged for HR generation)', 'Account Created', 'active', '2026-09-17T23:39:48.481Z'
)
ON CONFLICT (id) DO UPDATE SET
  full_name = EXCLUDED.full_name,
  personal_email = EXCLUDED.personal_email,
...
INSERT INTO public.employees (
  ...
  44, 1, 44, 'EMP-1044', NULL, 'QUEEN', 'ADJOGRI', 'QUEEN ADJOGRI', 'queendavid2222@gmail.com', 'queendavid2222@gmail.com', '+2348021275017', '9/19/2002', 'Single', 'Nigerian', 'Egbeda, Lagos', 'Odo eran, Egbeda', 'Lagos/Alimosho LGA', 'Delta State/ Lagos State', 'Delta State/ Lagos State', 'Pab Bus Stop', NULL, 'E edge direct2u', 'Warehouse Operation- Stock control Intern', '1/21/2026', '9 Emmanuel Olorunfemi str Ogba, Lagos', 'Miss Lynda', 'Blessing Adjogri', 'Sister', '+234 808 036 3531', '0+', 'Zenith Bank', '2256266458', 'Reading Novels', 'STAFF', TRUE, 'Missing official Staff ID (flagged for HR generation)', 'Account Created', 'active', '2026-09-17T23:39:48.575Z'
)
ON CONFLICT (id) DO UPDATE SET
  full_name = EXCLUDED.full_name,
  personal_email = EXCLUDED.personal_email,
...
INSERT INTO public.employees (
  ...
  49, 1, 49, 'EMP-1049', NULL, 'Daniel', 'Zabe', 'Daniel Zabe', 'zabedaniel8@gmail.com', 'zabedaniel8@gmail.com', '+2348129292596', '3/25/1995', 'Single', 'Nigeria', 'Road 2 1A Diamond Estate Igando', 'Road 1A Diamond Estate Igando', 'Lagos Alimosho', 'Bauchi state', 'Bauchi state', NULL, NULL, 'Procurement', 'Procurement', '1/12/2026', 'Atiba Osborne 15', 'Loveday', '0812 601 7260', 'Brother', '0812 601 7260', 'O+', 'Zabe Daniel', '2105297756', NULL, 'STAFF', TRUE, 'Missing official Staff ID (flagged for HR generation)', 'Account Created', 'active', '2026-09-17T23:39:48.753Z'
)
ON CONFLICT (id) DO UPDATE SET
  full_name = EXCLUDED.full_name,
  personal_email = EXCLUDED.personal_email,
...
INSERT INTO public.employees (
  ...
  51, 1, 51, 'EMP-1051', NULL, 'Odesina', 'Ayodeji Oluwaseye', 'Odesina Ayodeji Oluwaseye', 'odesinaseye@gmail.com', 'odesinaseye@gmail.com', '+2348033565543', '8/23/1985', 'Married', 'Nigerian', 'Ayandokun Compound behind Abiodun Atiba Grammar School Kosobo area, Oyo', 'Ayandokun Compound behind Abiodun Atiba Grammar School Kosobo area, Oyo', 'Oyo/ Oyo East', 'Oyo State', 'Oyo State', 'Durbar Police station', NULL, 'Regional Sales manager', 'VSR', '11/25/2025', 'Oyo town', 'Mr Ayoola', '08132527432', 'Wife', '08057833148', 'B+', 'GTB', '0845111036', 'Football', 'STAFF', TRUE, 'Missing official Staff ID (flagged for HR generation)', 'Account Created', 'active', '2026-09-17T23:39:48.861Z'
)
ON CONFLICT (id) DO UPDATE SET
  full_name = EXCLUDED.full_name,
  personal_email = EXCLUDED.personal_email,
...
INSERT INTO public.employees (
  ...
  53, 1, 53, 'EMP-1053', NULL, 'Simon', 'Hezekiah', 'Simon Hezekiah', 'simonhezekiah67@gmail.com', 'simonhezekiah67@gmail.com', '+2349077803201', '8/24/1997', 'Single', 'Nigerian', 'No 7, Adebayo street, peace avenue, araromi bus stop. Adiyan, Ogun state', 'No 9, Adebayo street,peace avenue, araromi bus stop, Adiyan ,Ogun state', 'Adiyan', 'Akwaibom state/ Ogun state', 'Akwaibom state/ Ogun state', 'Agbado Oja', NULL, 'Modern Trade', 'Logistics Executive', '10/6/2025', 'Maryland', 'Mrs Chidinma Mordi', '+234 902 007 9467', 'Mother', '0913 755 8229', 'O+', 'Access Bank', '1834001540', 'Cooking', 'STAFF', TRUE, 'Missing official Staff ID (flagged for HR generation)', 'Account Created', 'active', '2026-09-17T23:39:48.946Z'
)
ON CONFLICT (id) DO UPDATE SET
  full_name = EXCLUDED.full_name,
  personal_email = EXCLUDED.personal_email,
...
INSERT INTO public.employees (
  ...
  54, 1, 54, 'EMP-1054', NULL, 'ORJI', 'MICHAEL UCHECHI', 'ORJI MICHAEL UCHECHI', 'michaeorji222@gmail.com', 'michaeorji222@gmail.com', '+2349017542793', '5/20/2002', 'Single', 'NIGERIAN', '23, BAJULAYE SREET, SHOMOLU', '23, BAJULAYIE STREET', 'SHOMOLU/LAGOS', 'ABIA/BENDE', 'ABIA/BENDE', 'ONIPANU', NULL, 'CREATIVE', 'SOCIAL MEDIA/ GRAPHICS DESIGNER', '2/12/2026', 'MARYLAND', 'Head Of Creative', 'ORJI MICHAEL UCHECHI', 'BROTHER', '08038908818', '0-', 'Guaranty Trust Bank (GTB)', '0595274519', 'reading', 'STAFF', TRUE, 'Missing official Staff ID (flagged for HR generation)', 'Account Created', 'active', '2026-09-17T23:39:48.966Z'
)
ON CONFLICT (id) DO UPDATE SET
  full_name = EXCLUDED.full_name,
  personal_email = EXCLUDED.personal_email,
...
INSERT INTO public.employees (
  ...
  55, 1, 55, 'EMP-1055', NULL, 'Jonah', 'Daniel Agada', 'Jonah Daniel Agada', 'dannyjagas03@gmail.com', 'dannyjagas03@gmail.com', '+2347019147585', '4/3/1982', 'Married', 'Nigeria', '25 Fasali street Abar', '25 fasali street Abaranji ikotun lagos', 'Alimosho', 'Kogi state', 'Kogi state', 'Agbaduma Allom opposite UEC church', NULL, 'Driving', 'SUPERNUMERARY POLICE', '1/21/2026', 'Maryland', 'MR LOVEDAY', '0705 407 0771', 'Brother', '0705 407 0771', 'AA', 'Zenith Bank', '2282251026', 'Driving', 'STAFF', TRUE, 'Missing official Staff ID (flagged for HR generation)', 'Account Created', 'active', '2026-09-17T23:39:49.061Z'
)
ON CONFLICT (id) DO UPDATE SET
  full_name = EXCLUDED.full_name,
  personal_email = EXCLUDED.personal_email,
...
INSERT INTO public.employees (
  ...
  56, 1, 56, 'EMP-1056', NULL, 'Chiamaka', 'Favour', 'Chiamaka Favour', 'chiamakacf4286046@gmail.com', 'chiamakacf4286046@gmail.com', '+2348037486841', '1/4/1989', 'Married', 'Nigerian', 'Igando', 'Igando', 'Alimosho', 'Abia state', 'Abia state', 'Igando', NULL, 'Househelp', 'Househelp', '12/2/2024', 'Igando', 'MD', 'Chukwu', 'Brother', '+234 806 848 6193', 'No idea', 'Uba', '2356669429', 'Music', 'STAFF', TRUE, 'Missing official Staff ID (flagged for HR generation); Blood group unconfirmed', 'Account Created', 'active', '2026-09-17T23:39:49.077Z'
)
ON CONFLICT (id) DO UPDATE SET
  full_name = EXCLUDED.full_name,
  personal_email = EXCLUDED.personal_email,
...
INSERT INTO public.employees (
  ...
  57, 1, 57, 'EMP-1057', NULL, 'David', 'Oyedepo', 'David Oyedepo', 'tosinoyedepo5@gmail.com', 'davidoyedepo@eedge', '+2349077689952', '7/13/1977', 'Married', 'Nigerian', '12,Soore Close Orile Agege Lagos off jibowu street', '12, Soore Close Orile Agege off Old Ota Road', 'Orile Agege', 'Kwara/Lagos', 'Kwara/Lagos', 'Ilepo Bus stop', NULL, 'E-Edge Direct 2 you', 'VSR', '11/12/2021', 'Surulere', 'Valentine', '08125546996', 'Wife', '08125546996', 'O+', 'Opay', '08178044846', 'Basketball', 'STAFF', TRUE, 'Missing official Staff ID (flagged for HR generation)', 'Account Created', 'active', '2026-09-17T23:39:49.128Z'
)
ON CONFLICT (id) DO UPDATE SET
  full_name = EXCLUDED.full_name,
  personal_email = EXCLUDED.personal_email,
...
INSERT INTO public.employees (
  ...
  58, 1, 58, 'EMP-1058', NULL, 'Prince', 'Donald', 'Prince Donald', 'princedonald34@gmail.com', 'princedonald34@gmail.com', '+2348104590850', '10/23/2003', 'Single', 'Nigeria', 'No 31 onajimi street off Pedro road bariga', 'No 31 onajimi street off Pedro road bariga', 'Bariga', 'Abia state / Lagos', 'Abia state / Lagos', 'Onajimi street', NULL, 'Human Resource', 'HR / operations and capability executive', '3/16/2026', '15 Atiba Osborne street', 'Loveday lucky', 'Chief Emeka peters', 'Cousin', '+234 803 070 4448', 'O+', 'First bank plc', '3186057707', NULL, 'STAFF', TRUE, 'Missing official Staff ID (flagged for HR generation)', 'Account Created', 'active', '2026-09-17T23:39:49.146Z'
)
ON CONFLICT (id) DO UPDATE SET
  full_name = EXCLUDED.full_name,
  personal_email = EXCLUDED.personal_email,
...
INSERT INTO public.employees (
  ...
  66, 1, 66, 'EMP-1066', NULL, 'Abdulfatai', 'Abdulsalami', 'Abdulfatai Abdulsalami', 'aabdulsslami424@gmail.com', 'abdulsalami424@gmail.com', '+2347086546219', '2/13/1975', 'Married', 'Nigerian', '17 oyinbo orunmila street unity estate ojodu', '17 oyinbo orunmila unity estate ojodu', 'ikeja', 'kogi', 'kogi', 'Grammar school ojodu', NULL, 'Sales4', 'ASM', '5/4/2026', 'lagos', 'MD', 'Faisal lawal', 'friends', '08143240257', 'AA', 'zenith bank', '2001743672', 'Reading and jogging', 'STAFF', TRUE, 'Missing official Staff ID (flagged for HR generation)', 'Account Created', 'active', '2026-09-17T23:39:49.512Z'
)
ON CONFLICT (id) DO UPDATE SET
  full_name = EXCLUDED.full_name,
  personal_email = EXCLUDED.personal_email,
